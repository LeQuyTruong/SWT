                ...
                <div>
                    <div class="list_header">
                        <div class="main_title">
                            ...
                            Total: ${requestScope.TOTAL_RECORDS} Records(s)
                        </div>
                        <div>
                            <button
                                type="button"
                                class="btn btn-success"
                                style="padding: 8px 35px; font-size: 18px;background-color: #002752"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="createdebtor" method="get">
                                                ...
                                                <div class="mb-3" >
                                                    <button type="button" id="inputmale" class="male gender active" style="background-color: #002752;color: white">
                                                        Male
                                                    </button>
                                                    <button type="button" id="inputfemale" class="female gender" style="background-color: #002752;;color: white">
                                                        Female
                                                    </button>
                                                    <input
                                                        type="radio"
                                                ...
                                                <button type="submit" class="mr-1 btn btn-success" style="background-color:#002752 ;color: white">Thêm mới</button>
                                            </form>
                                        </div>
                            ...
                            <tbody>
                                ...
                                <c:forEach var="debtor" items="${requestScope.LiST_DEBTOR}">
                                    <tr >
                                        ...
                                        <th style="color: ${debtor.total_money < 0 ? "red" : "black"}"><p><fmt:formatNumber pattern="#,###" value="${debtor.total_money}" /> VNĐ</p></th>
                                        ...
                                        <th>
                                            <div style="width: 340px">
                                                ...
                                                <a href="debtList?debtorId=${debtor.debtor_id}">  
                ...
                <div class="pagination">
                    <ul>
                        ...
                        <li class="btn">
                            ...
                            <select id="size" name="size" class="form-select pagination-select" style="color: white" onchange ="defaultPage();
                                    document.inputValue.submit();">
                                <option style="color: black" value="1">1 Records</option>
                                <option style="color: black" value="2">2 Records</option>
                                <option style="color: black" value="3">3 Records</option>
                                <option style="color: black" value="5">5 Records</option>
                                <option style="color: black" value="10">10 Records</option>
                                <option style="color: black" value="20">20 Records</option>
                                <option style="color: black" value="30">30 Records</option>
                                <option style="color: black" value="40">40 Records</option>
                            </select>
