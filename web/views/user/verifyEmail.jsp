            ...
            <div class="content mt-5">
                ...
                <form action="verifyEmail" class="mt-4" id="verifyEmailForm" method="post"  >
                    ...
                    <div class="form-group mt-3 form-item-btn">
                        <div class="resend-btn" style="display: flex; align-items: center;">
                            <a href="resend?userId=${requestScope.userId}&typeOTP=${requestScope.typeOTP}" style=" text-decoration: none;color: white">Resend Code</a>
                        </div>
