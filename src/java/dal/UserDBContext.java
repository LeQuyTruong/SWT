...
public class UserDBContext extends DBContext {
    ...
    public String updateUser(int user_id, String display_name, String phone, String address, String txt) {
        ...
        try {
            ...
            st.executeUpdate();
            cookies = hc.addNoti(user_id, "success", "UpdateUser", txt);
        } catch (Exception e) {
            cookies = hc.addNoti(user_id, "fail", "UpdateUser", txt);
        }
        return cookies;
    }
