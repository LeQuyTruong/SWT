...
public class Debtor {
    ...
    public String toString() {
        return "Debtor{" + "debtor_id=" + debtor_id + ", debtor_name=" + debtor_name + ", address=" + address + ", gender=" + gender + ", email=" + email + ", phone_number=" + phone_number + ", created_time=" + created_time + ", updated_time=" + updated_time + ", created_by=" + created_by + ", total_money=" + total_money + ", gen=" + gen + '}';
    }
