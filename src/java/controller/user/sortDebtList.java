 ...
 * @author asus
 */
public class sortDebtList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Debtor debtor = debtorService.getDebtorById(Integer.parseInt(debtorID));
        DebtDBContext debtDB = new DebtDBContext();
        ArrayList<Debt> debts = debtDB.sortDebtList(Integer.parseInt(debtorID), choice, value);
